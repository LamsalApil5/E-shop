                ...
                <div className='container flex justify-between items-center'>
                    ...
                    <div>
                        ...
                        <button
                         ...
                         text-white py-1 px-4 rounded-full flex item-center gap-3 group'>
            ...
            <div className='flex justify-center'>
                <ul className='sm:flex hidden items-center gap-4'>
                    ...
                    <li className='group relative cursor-pointer'>
                        ...
                        <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-none-md bg-white p-2 text-black shadow-md'>
                            <ul>
